                ...
                <fieldset>
                    ...
                    <div class="form-group{{ $errors->has('subtitulo') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="subtitulo" type="text" class="form-control" name="subtitulo"
                                   value="{{ old('subtitulo') }}" autofocus> @if ($errors->has('subtitulo'))
                                <span class="help-block">
                    ...
                    <div class="form-group{{ $errors->has('conteudo') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <textarea id="conteudo" class="form-control" name="conteudo"
                                      autofocus>{{ old('conteudo') }}</textarea> @if ($errors->has('conteudo'))
                                <span class="help-block">
                    ...
                    <div class="form-group{{ $errors->has('keywords') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="keywords" type="text" class="form-control" name="keywords"
                                   value="{{ old('keywords') }}" autofocus> @if ($errors->has('keywords'))
                                <span class="help-block">
                    ...
                    <div class="form-group{{ $errors->has('published_at') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="published_at" type="date" name="published_at" class="form-control"
                                   value="{{ old('published_at') }}" autofocus> @if ($errors->has('published_at'))
                                <span class="help-block">
                    ...
                    <div class="form-group{{ $errors->has('anexo') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6" style="position: inherit;">
                            <input style="position: inherit;" id="anexo" type="file" class="form-control-file"
                                   name="anexo" value="{{ old('anexo') }}"
        ...
        <div class="col-md-4">
            ...
            <ul id="ultimasNoticias">
                @forelse($noticias as $noticia)
                    <li>{{$noticia->titulo}} - <strong>{{$noticia->published_at->format('d/m/Y')}}</strong></li>
                @empty
                    <li class="nenhumaNoticia">Nenhuma notícia cadastrada ainda</li>
                @endforelse
            </ul>
        </div>
    </div>
